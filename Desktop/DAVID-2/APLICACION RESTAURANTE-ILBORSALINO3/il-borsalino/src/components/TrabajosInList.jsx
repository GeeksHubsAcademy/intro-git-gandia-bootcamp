...
//No puedo utilizar un class component porque useNavigation es un hook, y los hook solo funcionan en los function component
// class TrabajosInList extends Component {
//     constructor(props) {
//         super(props)
//         this.state = {
//            loading: true,
...
//     componentDidMount(){
//         getTrabajosInList = (props) => {
//             description = props.offer.description
//             substring = description.substr(0,90) + '\u2026'
//             this.setState({loading: false,  substring: substring})
//         };
//         getTrabajosInList(this.props)
...
//                         <View>
//                         <Text style={styles.textBold}>{this.props.offer.title}</Text>
//                         </View>
//                         {this.props.offer.image ? <ScaledImage style={{marginTop: 20, marginBottom: 20}} uri={this.props.offer.image_link} width={300} /> : null}
//                         <View>
//                         </View>
//                         <View>
//                             <Text style={this.determineIfActive(this.props.offer) ? styles.textActive : styles.textNotActive}>{this.props.offer.readabledate}</Text>
//                         </View>
//                         <View>
//                         <Text style={styles.text}>{this.state.substring}</Text>
//                         </View>
//                     </View>
...
//                     }
//                     }>
//                         <Text style={styles.textbutton}>Aplicar al puesto</Text>
//                     </TouchableOpacity>
//                 </View>
